...
final channelTimelineProvider = StreamProvider.family
...
final channelDraftProvider = StreamProvider.family
    .autoDispose<Result<Draft?>, String>(
      (ref, channelId) =>
          ref.watch(messagingEngineProvider).watchDraft(channelId),
    );
